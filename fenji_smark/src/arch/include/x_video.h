...
extern void StartVideoStreamDecode(void);     //打开视频流解码
extern void StopVideoStreamDecode(void);      //关闭视频流解码

extern INT8U Mjpeg_DecodeError;

extern INT8U VideoFrameRate[6];

extern void DecoceVideo(INT32U Video_Maddr, INT32U Video_Len);
